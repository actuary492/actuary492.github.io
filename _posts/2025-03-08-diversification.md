...
$$
\frac{1}{n} \frac{1}{n} \sum_{i}^{n} \sum_{\substack{j=1 \\ j \neq i}}^{n} \text{Cov}(R_i, R_j) = \frac{1}{n} \frac{1}{n} \frac{n(n-1)}{1} \frac{1}{n(n-1)} \sum_{i}^{n} \sum_{\substack{j=1 \\ j \neq i}}^{n} \text{Cov}(R_i, R_j) = \frac{1}{n} \frac{1}{n} (\frac{n(n-1)}{1} \frac{1}{n(n-1)} \sum_{i}^{n} \sum_{\substack{j=1 \\ j \neq i}}^{n} \text{Cov}(R_i, R_j)) = \frac{1}{n} \frac{1}{n} \frac{n(n-1)}{1} \overline{\text{Cov}(R_i, R_j)}} = \frac{n-1)}{n} \overline{\text{Cov}(R_i, R_j)}}
$$
