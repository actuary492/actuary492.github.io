...
$$
\sum_{i=1}^{n} y_i x_i - \bar{y_i} \sum_{i=1}^{n} x_i - \hat{\beta} \sum_{i=1}^{n} x_i - \hat{\beta} \bar{x_i} \sum_{i=1}^{n} x_i - \hat{\beta} \sum_{i=1}^{n} x_i = 0 
$$

$$
\sum_{i=1}^{n} y_i x_i - \bar{y_i} \sum_{i=1}^{n} x_i - \hat{\beta}*(\sum_{i=1}^{n} x_i + \bar{x_i} \sum_{i=1}^{n} x_i + \sum_{i=1}^{n} x_i)
$$
