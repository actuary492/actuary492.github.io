...
- Assume increasing interest rates starting from $3$% at $t=1$, and decreasing $0.5$% yearly. This means that if our cashflows are at t=1, t=2 we must discount it by $3$% and $3.5$% respectively, and so on. We can assume this reflects the forecasted inflation path in the future. 
